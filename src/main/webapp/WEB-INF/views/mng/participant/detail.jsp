                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered align-middle gs-7 gy-4">
                            ...
                            <tr>
                                <th class="bg-light fw-bold">도착(QR) 확인 여부</th>
                                <td colspan="3">
                                    <c:choose>
                                        <c:when test="${empty data.qrScanTime}"><span
                                                class="text-danger fw-bold">미도착</span></c:when>
                                        <c:otherwise>
                                            <span class="text-success fw-bold">도착 확인 완료</span>
                                            (<fmt:parseDate value="${data.qrScanTime}" pattern="yyyy-MM-dd'T'HH:mm:ss"
