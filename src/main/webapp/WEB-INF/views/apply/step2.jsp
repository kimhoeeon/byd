                ...
                <div class="inner">
                    ...
                    <form action="/apply/applyProcess" method="post" id="applyForm2" onsubmit="return validateForm();">
                        ...
                        <div class="terms-check">
                            ...
                            <textarea readonly>BYD코리아는 시승 신청 및 고객 상담 서비스 제공을 위하여 아래와 같이 개인정보를 수집·이용합니다. &#10; &#10;수집 항목: 이름, 전화번호, 이메일 주소, 시승 신청 시간, 시승 신청 전시, 시승 신청 차량&#10;수집 및 이용 목적: 시승 안내, 문의 응대 및 상담 진행, 고객 관리, 차량 구매 관련 안내 제공, 서비스 품질 개선 및 운영 통계 분석&#10;보유 및 이용 기간: 처리 목적 달성 시 또는 고객의 동의 철회 시까지&#10;&#10;고객은 개인정보 수집·이용에 대한 동의를 거부할 권리가 있습니다. 다만, 필수 정보 제공에 대한 동의를 거부할 경우 시승 신청 및 상담 서비스 이용이 제한될 수 있습니다.</textarea>
                        </div>
                        <div class="terms-check">
                            <label>
                        ...
                        <div class="terms-check">
                            ...
                            <textarea readonly>BYD코리아는 원활한 이벤트 운영 및 시승 신청 페이지 운영을 위하여 아래와 같이 개인정보 처리 업무를 위탁할 수 있습니다.&#10;&#10;수탁업체: ㈜엔피&#10;위탁 업무 내용: 이벤트 페이지 개발 및 운영, 시승 신청 정보 수집, 고객 데이터 전달 및 운영 지원&#10;보유 및 이용 기간: 위탁업무 수행기간 동안 보관하며, 위탁업무 종료시 지체 없이 파기' (이용 기간: 2026.05.15 ~ 2026. 06.15)&#10;&#10;BYD코리아는 개인정보 보호법에 따라 위탁계약 체결 시 개인정보가 안전하게 관리될 수 있도록 필요한 사항을 규정하고 관리·감독하고 있습니다.</textarea>
                        </div>
                        <div class="terms-check">
                            <label>
                    ...
                    $('#testDriveTime option').each(function() {
                        ...
                        if(timeVal !== "시승 미신청") {
                            ...
                            if (currentHour > targetHour) {
                                ...
                                // 현재 시각이 예약 타임과 같으면 이미 시작된 것으로 간주하여 마감
                                isPassed = true;
                            }

                            // 인원이 찼거나 시간이 지났다면 비활성화
                            if(isFull || isPassed) {
