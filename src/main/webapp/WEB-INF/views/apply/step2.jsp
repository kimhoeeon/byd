                ...
                <div class="inner">
                    ...
                    <form action="/apply/applyProcess" method="post" id="applyForm2" onsubmit="return validateForm();">
                        ...
                        <div class="terms-check">
                            ...
                            <textarea readonly>BYD코리아는 원활한 이벤트 운영을 위하여 아래와 같이 개인정보 처리 업무를 위탁할 수 있습니다.&#10;&#10;수탁업체: (주)컴투스엔&#10;위탁 업무 내용: 이벤트 페이지 개발 및 운영, 고객 데이터 전달 및 운영 지원&#10;보유 및 이용 기간: 위탁 계약 종료 시까지&#10;&#10;BYD코리아는 개인정보 보호법에 따라 위탁계약 체결 시 개인정보가 안전하게 관리될 수 있도록&#10;필요한 사항을 규정하고 관리·감독하고 있습니다.</textarea>
                        </div>
                        <div class="terms-check">
                            <label>
