...
<body class="apply_w">
                ...
                <div class="inner">
                    ...
                    <form id="updateForm">
                                ...
                                <div class="row email">
                                    ...
                                    <div class="input">
                                        <select id="emailDomain">
                                            ...
                                            <option value="daum.net" <c:if test="${savedEmailDomain == 'daum.net'}">selected</c:if>>daum.net</option>
                        ...
                        <div class="terms-check">
                            ...
                            <textarea readonly>BYD코리아는 고객 상담, 이벤트 운영 및 차량 구매상담 연결을 위하여 아래와 같이 개인정보를 제3자에게 제공할 수 있습니다.&#10;&#10;제공받는 자: 비와이디코리아 유한회사의 공식 딜러사(*)중 고객이 선택한 전시장이 속한 딜러사&#10;*BYD 공식딜러사: 디티네트웍스㈜, ㈜삼천리이브이, 하모니오토모빌(유), ㈜비전모빌리티, 지엔비모빌리티㈜, 에스에스모터스㈜&#10;제공하는 개인정보: 이름, 휴대폰 번호, 이메일 주소, 관심 차종&#10;제공 목적: 이벤트 운영, 이벤트 일정 안내, 차량 상담 및 문의 응대, 견적 제공 및 구매 상담 연결	&#10;보유 및 이용기간: 이벤트 및 상담 종료 후 6개월까지 또는 고객의 동의 철회 시까지. 단, 관계 법령에 따라 보존이 필요한 경우 해당 기간 동안 보관&#10;&#10;고객은 개인정보 제3자 제공에 대한 동의를 거부할 권리가 있습니다. 다만, 동의하지 않을 경우 이벤트 운영 및 딜러 상담 연결이 제한될 수 있습니다.</textarea>
                        </div>
                        <div class="terms-check">
                            <label>
                                <input type="checkbox" checked disabled>
                            ...
                            <textarea readonly>BYD코리아는 원활한 이벤트 운영을 위하여 아래와 같이 개인정보 처리 업무를 위탁합니다.&#10;&#10;수탁업체: ㈜엔피&#10;위탁 업무 내용: 이벤트 페이지 개발 및 운영, 이벤트 운영 지원&#10;보유 및 이용 기간: 위탁업무 수행 기간 동안 보관하며, 위탁업무 종료시 지체 없이 파기</textarea>
                        </div>
                        <div class="terms-check">
                            <label>
                                <input type="checkbox" checked disabled>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // 3. [마이페이지 고유] 정보 수정 버튼 클릭 시 AJAX 전송
            $("#btnUpdate").on("click", function(e) {
                e.preventDefault();

                if(validateCombinedForm()) {
                    if(confirm("입력하신 정보로 이벤트 참여 정보를 수정하시겠습니까?")) {
